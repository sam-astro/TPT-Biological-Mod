...
void Element::Element_FLUO()
{
	Identifier = "DEFAULT_PT_FLUO";
	Name = "FLUO";
	Colour = PIXPACK(0xafff24);
	MenuVisible = 1;
	MenuSection = SC_GAS;
	Enabled = 1;
	...
	HeatConduct = 70;
	Description = "Fluorine Gas, very toxic and reacts with most other elements.";
	...
	for (int rx = -2; rx <= 2; rx++)
		for (int ry = -2; ry <= 2; ry++)
			if (BOUNDS_CHECK && (rx || ry))
			{
				...
				else if (TYP(r) != PT_ACID && TYP(r) != PT_FLUO && TYP(r) != PT_RFRG && TYP(r) != PT_RFGL)
				{
