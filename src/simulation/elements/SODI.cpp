...
{
	Identifier = "DEFAULT_PT_SODI";
	Name = "SODI";
	Colour = PIXPACK(0x858383);
	MenuVisible = 1;
	...
	HeatConduct = 70;
	Description = "Sodium. Reactive element that explodes on contact with water.";
...
For game reasons, baseline SODI has the reactions of both its pure form and
...
If SODI comes in contact with water, it will consume 1 WATR, increment tmp,
